var Snow = function (options, pos = 0) {
    ...
    this.canvas.height =  document.querySelectorAll(`.${options.id}`)[pos].clientHeight;
    this.canvas.style.position = 'absolute';
    this.canvas.style.left = '0';
    this.canvas.style.top = '0';
    this.canvas.style.zIndex = '-1';
    document.querySelectorAll(`.${options.id}`)[pos].appendChild(this.canvas);
